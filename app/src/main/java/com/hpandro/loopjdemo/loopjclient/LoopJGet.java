...
public class LoopJGet {
     ...
     * @param url
     */
    public LoopJGet(Context ctx, String progressMessage, final OnLoopJGetCallComplete onLoopJGetCallComplete, String url) {
...
//                SocialAuthAdapter adapter = new SocialAuthAdapter(responseListener);
            ...
            public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
                ...
                System.out.println("++++++ Response onFailure: " + responseString.toString());
